...
func (o *PostLoginBody) validateName(formats strfmt.Registry) error {

	if err := validate.Required("credentials"+"."+"name", "body", o.Name); err != nil {
		return err
	}

	if err := validate.MinLength("credentials"+"."+"name", "body", string(*o.Name), 1); err != nil {
		return err
	}
...
func (o *PostLoginBody) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("credentials"+"."+"password", "body", string(*o.Password), 1); err != nil {
		return err
	}
