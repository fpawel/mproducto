...
func (o *GetUserOK) WithPayload(payload *model.User) *GetUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user o k response
func (o *GetUserOK) SetPayload(payload *model.User) {
	o.Payload = payload
}
...
func (o *GetUserDefault) WithPayload(payload *model.Error) *GetUserDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user default response
func (o *GetUserDefault) SetPayload(payload *model.Error) {
	o.Payload = payload
}
